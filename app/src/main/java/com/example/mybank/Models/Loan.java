...
public class Loan {
    ...
    int _id,user_id,transaction_id;
    double init_amount,remained_amount,monthly_payment,monthly_roi;
    String  init_date,finish_date,name;

    public Loan() {
    }

    public Loan(int _id, int user_id, int transaction_id, double init_amount, double remained_amount, double monthly_payment, double monthly_roi, String init_date, String finish_date, String name) {
        this._id = _id;
